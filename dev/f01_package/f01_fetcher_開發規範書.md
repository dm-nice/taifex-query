...
**格式說明（v5.0- **格式**: `[YYYY.MM.DD]  F01: [描述] : [數值] [單位] [來源]`
- **範例**:
  - 成功: `2025.12.10  F01: 台指期貨外資 [未平倉] [多空淨額] : -26,823 口 [TAIFEX]`
  - 失敗: `2025.12.10  F01 錯誤: 該日無交易資料（可能是假日或休市日） [TAIFEX]`
- 回傳類型: `str` (字串)
- **成功格式**: `[YYYY.MM.DD]  F01: 台指期貨外資 [未平倉] [多空淨額] : {net:,} 口 [TAIFEX]`
  - 模組代號: `F01` (大寫)
  - 標題: `台指期貨外資`
  - 標籤: `[未平倉] [多空淨額]`
  - 數值: 淨額口數，使用千分位逗號 (如 `-29,439`)
  - 來源: `[TAIFEX]`
- **錯誤格式**: `[YYYY.MM.DD]  F01 錯誤: {錯誤訊息} [TAIFEX]`
  - 模組代號: `F01` (大寫)
  - 錯誤標記: `錯誤:`
  - 錯誤訊息: 中文說明
  - 來源: `[TAIFEX]`
