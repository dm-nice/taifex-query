...
👉 **不知道從何開始？** → [**QUICK_GUIDES.md**](QUICK_GUIDES.md) ⭐⭐⭐

| 我想... | 用時 | 指南 |
|--------|------|------|
| 快速試驗新想法 | 20 分鐘 | [開發試驗版.md](OpenSpec_開發試驗版.md) |
| 正式開發新模組 | 4.5 小時 | 本文件的「OpenSpec 4-Phase 標準」 |
| 參考完整例子 | 30 分鐘 | [F11 範本](f11_package/) |
| 了解開發規範 | 10 分鐘 | [共同開發規範書](共同開發規範書_V1.md) |
